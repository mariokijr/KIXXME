                    ...
                    <FormItem>
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="h-[52px] rounded-2xl border-white/10 bg-white/[0.08] text-white placeholder:text-white/40 focus-visible:border-[#a855f7] focus-visible:ring-1 focus-visible:ring-[#a855f7] px-5 text-base transition-colors"
